  ...
  return (
    <>
      ...
      <div style={{ wordBreak: "break-word" }}>
        <h1 className={TYPOGRAPHY_CLASSES_MAP.headingLg}>Privacy Policy</h1>
        ...
        <ul>
          <li className="list-item-paragraph">
            <p>
              <i>Account</i> means a unique account created for You to access
          ...
          <li className="list-item-paragraph">
            <p>
              <i>Cookies</i> are small files that are placed on Your computer,
          ...
          <li className="list-item-paragraph">
            <p>
              <i>Personal Data</i> is any information that relates to an
          ...
          <li className="list-item-paragraph">
            <p>
              <i>Service Provider</i> means any natural or legal person who
          ...
          <li className="list-item-paragraph">
            <p>
              <i>Third-party Social Media Service</i> refers to any website or
        ...
        <h2 className={TYPOGRAPHY_CLASSES_MAP.headingBig}>
          Types of Data Collected
        </h2>
        <h3 className={TYPOGRAPHY_CLASSES_MAP.headingMd}>Personal Data</h3>
        <p>
        ...
        <h3 className={TYPOGRAPHY_CLASSES_MAP.headingMd}>Usage Data</h3>
        ...
        <h3 className={TYPOGRAPHY_CLASSES_MAP.headingMd}>
        ...
        <ul>
          <li className="list-item-paragraph">Google</li>
          <li className="list-item-paragraph">Facebook</li>
          <li className="list-item-paragraph">Twitter</li>
          <li className="list-item-paragraph">TikTok</li>
        </ul>
        <p>
        ...
        <ul>
          <li className="list-item-paragraph">
            <i>Cookies or Browser Cookies.</i> A cookie is a small file placed
          ...
          <li className="list-item-paragraph">
            <i>Flash Cookies.</i> Certain features of our Service may use local
          ...
          <li className="list-item-paragraph">
            <i>Web Beacons.</i> Certain sections of our Service and our emails
        ...
        <ul>
          <li className="list-item-paragraph">
            <p>
              <i>Necessary / Essential Cookies</i>
            </p>
          ...
          <li className="list-item-paragraph">
            <p>
              <i>Cookies Policy / Notice Acceptance Cookies</i>
            </p>
        ...
        <ul>
          <li className="list-item-paragraph">
            <p>
              <i>To provide and maintain our Service</i>, including to monitor
              the usage of our Service.
            </p>
          </li>
          <li className="list-item-paragraph">
            <p>
              <i>To manage Your Account:</i> to manage Your registration as a
          ...
          <li className="list-item-paragraph">
            <p>
              <i>For the performance of a contract:</i> the development,
          ...
          <li className="list-item-paragraph">
            <p>
              <i>To contact You:</i> To contact You by email, telephone calls,
          ...
          <li className="list-item-paragraph">
            <p>
              <i>To provide You</i> with news, special offers and general
          ...
          <li className="list-item-paragraph">
            <p>
              <i>To manage Your requests:</i> To attend and manage Your requests
              to Us.
            </p>
          </li>
          <li className="list-item-paragraph">
            <p>
              <i>For business transfers:</i> We may use Your information to
          ...
          <li className="list-item-paragraph">
            <p>
              <i>For other purposes</i>: We may use Your information for other
        ...
        <ul>
          <li className="list-item-paragraph">
            <i>With Service Providers:</i> We may share Your personal
            information with Service Providers to monitor and analyze the use of
            our Service, to contact You.
          </li>
          <li className="list-item-paragraph">
            <i>For business transfers:</i> We may share or transfer Your
          ...
          <li className="list-item-paragraph">
            <i>With Affiliates:</i> We may share Your information with Our
          ...
          <li className="list-item-paragraph">
            <i>With business partners:</i> We may share Your information with
            Our business partners to offer You certain products, services or
            promotions.
          </li>
          <li className="list-item-paragraph">
            <i>With other users:</i> when You share personal information or
          ...
          <li className="list-item-paragraph">
            <i>With Your consent</i>: We may disclose Your personal information
        ...
        <h3 className={TYPOGRAPHY_CLASSES_MAP.headingMd}>Law enforcement</h3>
        <p>
        ...
        <h1 className={TYPOGRAPHY_CLASSES_MAP.headingLg}>Children's Privacy</h1>
        <p>
