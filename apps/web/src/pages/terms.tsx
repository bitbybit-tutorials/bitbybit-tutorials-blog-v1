...
export default function TermsPage() {
  return (
    <>
      ...
      <div>
        <h1 className={TYPOGRAPHY_CLASSES_MAP.headingLg}>
        ...
        <h2 className={TYPOGRAPHY_CLASSES_MAP.headingBig}>Interpretation</h2>
        <p>
        ...
        <h2 className={TYPOGRAPHY_CLASSES_MAP.headingBig}>Definitions</h2>
        <p>For the purposes of these Terms and Conditions:</p>
        <ul>
          <li className="list-item-paragraph">
            <p>
              <i>Affiliate</i> means an entity that controls, is controlled by
          ...
          <li className="list-item-paragraph">
            <p>
              <i>Country</i> refers to: United Kingdom
            </p>
          </li>
          <li className="list-item-paragraph">
            <p>
              <i>Company</i> (referred to as either &quot;the Company&quot;,
              &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this
              Agreement) refers to Bitbybit Tutorials.
            </p>
          </li>
          <li className="list-item-paragraph">
            <p>
              <i>Device</i> means any device that can access the Service such as
          ...
          <li className="list-item-paragraph">
            <p>
              <i>Terms and Conditions</i> (also referred as &quot;Terms&quot;)
          ...
          <li className="list-item-paragraph">
            <p>
              <i>Third-party Social Media Service</i> means any services or
          ...
          <li className="list-item-paragraph">
            <p>
              <i>Website</i> refers to Bitbybit Tutorials, accessible from{" "}
              <a
                className="link-alt"
                href="https://www.bitbybit-tutorials.com"
                rel="external nofollow noopener noreferrer"
                target="_blank"
              >
                https://www.bitbybit-tutorials.com
              </a>
            </p>
          </li>
          <li className="list-item-paragraph">
            <p>
              <i>You</i> means the individual accessing or using the Service, or
              the company, or other legal entity on behalf of which such
              individual is accessing or using the Service, as applicable.
            </p>
          </li>
        </ul>
        <h1 className={TYPOGRAPHY_CLASSES_MAP.headingLg}>Acknowledgment</h1>
        <p>
        ...
        <h1 className={TYPOGRAPHY_CLASSES_MAP.headingLg}>Termination</h1>
        <p>
        ...
        <h1 className={TYPOGRAPHY_CLASSES_MAP.headingLg}>Governing Law</h1>
        <p>
        ...
        <h2 className={TYPOGRAPHY_CLASSES_MAP.headingBig}>Severability</h2>
        <p>
        ...
        <h2 className={TYPOGRAPHY_CLASSES_MAP.headingBig}>Waiver</h2>
        <p>
        ...
        <h1 className={TYPOGRAPHY_CLASSES_MAP.headingLg}>Contact Us</h1>
        <p>
        ...
        <ul>
          <li className="list-item-paragraph">
            By email: bitbybit_tutorials@yahoo.com
          </li>
        </ul>
      </div>
    </>
